...
app.post("/api/run", async (req, res) => {
    ...
    exec(
        `javac -cp /home/runner/${process.env.REPL_SLUG}/src/libs/selenium-server-4.10.0.jar ${filePath} && java -cp /home/runner/${process.env.REPL_SLUG}/src/libs/selenium-server-4.10.0.jar:/tmp Main`,
        (error, stdout, stderr) => {
            if (error) {
